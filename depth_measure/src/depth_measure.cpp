...
public:
  ...
  DepthMeasureApp()
    ...
    //image_v_(0)
  {
    camera_matrix_left_ = (cv::Mat_<double>(3,3) << 2383.548069707908, -1.494360539974599, 1002.442767469957, 0, 2380.947486966119, 750.5093387314321, 0, 0, 1);
    camera_matrix_right_ = (cv::Mat_<double>(3,3) << 2380.989164362347, -1.037059958490927, 983.6392803642979, 0, 2379.232537405887, 751.2624841464575, 0, 0, 1);
    distcoeff_left_ = (cv::Mat_<double>(1,5) << -0.247371542236732, 0.308693224659528, 0.000666856506282038, 0.000268184126800787, -0.310361973595874);
    distcoeff_right_ = (cv::Mat_<double>(1,5) << -0.230422631444263, 0.157905923163391, 0.000685338774623599, -0.0000758613415520575, -0.0438237924191278);
    ...
    Q_ = (cv::Mat_<double>(4,4) << 1, 0, 0, -986.5414733886719, 0, 1, 0, -751.6800231933594, 0, 0, 0, 2210.723852459547, 0, 0, 0.001782589614268208, -0);
  }
};
